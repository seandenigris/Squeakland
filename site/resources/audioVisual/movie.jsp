...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title> squeakland : resources : audio/visual : movie </title>
...
<area alt="Resources" coords="147, 7, 223, 27" href="../index.html" shape="rect" title="Resources"/>
...
<td><img alt="" border="0" height="29" id="navTop" name="navTop" src="../../images/mainNav-resources.png" usemap="#mainNavMap" width="368"/></td>
...
<div class="subNav">
<ul>
<li class="vertRule"><a href="../../tutorials/screencasts/index.html">community</a></li>
<li class="vertRule"><a href="../../tutorials/guides/index.html">articles</a></li>
<li class="vertRule"><a href="../../tutorials/demos/index.html">books</a></li>
<li><a href="../../tutorials/courseware/index.html" style="color: #009900;">audio/visual</a></li>
</ul>
</div>
</td>
...
<area alt="previous" coords="1,3,58,22" href="movie.jsp" shape="rect" title="previous"/>
</map>
<table width="320">
<tr align="center">
<td width="10%"> </td>
<td width="80%">
<span class="body">tue.1 - Waveplace - William Stelzer</span>
</td>
<td width="10%"> </td>
</tr>
<tr><td> </td></tr>
...
<script language="JavaScript" type="text/javascript">
                  <!--
                     ...
                     {
                        var so = new SWFObject('/sm/includes/flvplayer.swf','player','320','260','7');
                        so.addParam("allowfullscreen","true");
                        so.addVariable("file","http://www.squeakland.org/content/movies/sf09-d2s1-waveplace.flv" );
