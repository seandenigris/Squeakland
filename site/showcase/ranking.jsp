...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title> squeakland : showcase : ranking </title>
...
<div class="articleBody" id="body220">
<img border="0" class="articleEmbeddedImage" src="../content/articles/thumb/level7.gif"/>
               ...
               The Squeakland Showcase uses a distributed ranking system, which is designed to give editorial power to those that have proven themselves. When you post projects and comments to the showcase, you may gain or lose "points", which are a measure of your contributions.  <br/>
<br/>
Every time you post a project, ten members of the community are chosen to rank your project.  The points they assign are combined with your total points. Rankers are chosen based upon their relative point levels.  Higher levels are more likely to be chosen. <br/>
<br/>
Here's how you can gain points:<br/>
<ul><li>Posting a public project .. 1 to 400 points</li><li>Ranking a project .. 10 points</li><li>Adding a comment .. 5 points</li><li>Clicking "Not This Time" .. 1 point</li></ul>The highest ranking project for week before last is emailed as the "Weekly Wow" each Monday.  The cutoff for inclusion is Sunday midnight ET (5:00 GMT).<br/>
<br/>
An account's level is indicated by a small circle next to each username. Here are the levels, along with the number of accounts at each level.<br/>
</div>
</td>
</table></td></tr>
</table>
<!-- content start -->
<table class="mojoLevelTable">
<tr>
<td><img src="../sm/images/mojo/default/level5.png"/></td>
<td>Level 5</td>
<td>(1)</td>
</tr>
<tr>
<td><img src="../sm/images/mojo/default/level4.png"/></td>
<td>Level 4</td>
<td>(1)</td>
</tr>
<tr>
<td><img src="../sm/images/mojo/default/level3.png"/></td>
<td>Level 3</td>
<td>(1)</td>
</tr>
<tr>
<td><img src="../sm/images/mojo/default/level2.png"/></td>
<td>Level 2</td>
<td>(9)</td>
</tr>
<tr>
<td><img src="../sm/images/mojo/default/level1.png"/></td>
<td>Level 1</td>
<td>(22)</td>
</tr>
<tr><td> </td></tr>
