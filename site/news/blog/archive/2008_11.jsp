...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: November 2008</title>
<!--
...
<br/>
<!-- content start -->
<a class="entryTitle" href="000815.jsp">Etoys in Uruguay</a>   <span class="entryLinks">26-Nov-08 (teefal)</span><br/>
<br/>
<div class="entryText">
         Here is a link out of Uruguay showing how to use Etoys to create "books": http://ceibalflorida.blogspot.com/search/label/etoys They are still using XO SW release 656 in Uruguay and I'm not sure which version of Etoys they have (maybe you can tell from the screen shots?). Its great that they have learned how to create books, include images from the XO camera and post that to the Web. That's not trivial with XO 656! There are also some posts on using eToys to teach geometry. Lastly, I saw a thread on using EToys to create concept maps on our Spanish language list....
      </div>
<br/>
<br/>
<br/>
