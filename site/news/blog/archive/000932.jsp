...
<link href="000929.jsp" rel="prev" title=" Etoys 4 release candidate and beta showcase"/>
<link href="000933.jsp" rel="next" title="squeakland showcase is done, for now"/>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/archive/000932.jsp">
<dc:title> Please Upload Your Etoys Projects</dc:title>
<dc:description>With the launch of the beta Squeakland Showcase, we&apos;d love for any and all to upload their favorite Etoys projects! Think of it as a Squeakland housewarming party, which for those that don&apos;t know the term, it&apos;s when friends come to your new house with gifts to make the house nicer for everyone. There&apos;s two ways you can upload projects: 1) If you&apos;re using the Etoys 4 release candidate, you can upload directly from Etoys. 2) If you&apos;re already got some PR files, the go to the showcase upload page: http://squeakland.org/showcase/upload&apos;&gt; http://squeakland.org/showcase/upload Either way, you&apos;ll need to create a free...</dc:description>
<dc:creator>timothy</dc:creator>
<dc:date>2009-09-20T04:25:30-08:00</dc:date>
...
<a href="000929.jsp">«  Etoys 4 release candidate and beta showcase</a> |
   <a href="../index.html">Main</a>
   | <a href="000933.jsp">squeakland showcase is done, for now »</a>
</div>
<br/>
<br/>
<div class="entryDate">September 20, 2009</div>
<a name="000932"></a>
<div class="entryTitle">
   Please Upload Your Etoys Projects<br/>
</div>
<div class="entryText">
<p>With the launch of the beta Squeakland Showcase, we'd love for any and all to upload their favorite Etoys projects!</p>
<p>Think of it as a Squeakland housewarming party, which for those that don't know the term, it's when friends come to your new house with gifts to make the house nicer for everyone.</p>
<p>There's two ways you can upload projects:</p>
<p>1) If you're using the Etoys 4 release candidate, you can upload directly from Etoys.</p>
<p>2) If you're already got some PR files, the go to the showcase upload page:</p>
<p><a href="&lt;br /&gt;http:/squeakland.org/showcase/upload.html"><br/>
http://squeakland.org/showcase/upload</a></p>
<p>Either way, you'll need to create a free account first.</p>
<p>A few warnings though:</p>
<p>A) any projects or project information with inappropriate content for children will be immediately deleted</p>
<p>B) the showcase does not currently support non-latin alphabets (8859-1), such as Japanese, Russian, etc. We will fix this as soon as we can. You can still upload projects in these other languages, you just cannot use your alphabets in the project title, description, author, or tags.</p>
<p>C) children under 13 must have their parent or guardian create their account for them</p>
<p>We hope to have a great selection of projects before we go live with the Etoys 4 final on October 21st. Please spread the word to everyone you know.</p>
<p>Please help us spruce up the showcase!</p>
<a name="more"></a>
</div>
<br/>
<div class="entryLinks">
