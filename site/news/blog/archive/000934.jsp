...
<br/>
<br/>
<div class="entryDate">September 30, 2009</div>
<a name="000934"></a>
<div class="entryTitle">
   Etoys 4 release candidate 2<br/>
</div>
<div class="entryText">
<p>We've just posted the second Etoys 4 release candidate:</p>
<p><a href="../../../download/index.html">http://squeakland.org/download/</a></p>
<p>(scroll to bottom of page)</p>
<p>This one has more translations and some bug fixes. We're one step closer to our final release on October 21st.</p>
<p>Please help us by testing RC2 with your existing projects, and some new ones.</p>
<p>And while you're there, upload a few to the showcase!</p>
<p>Feel free to add tickets to our tracker.</p>
<p>Here's a list of <a href="../../../secure/IssueNavigator.jspa">RC2 changes.</a></p>
<p>Here's a list of current <a href="../../../secure/IssueNavigator.jspa">known issues.</a><br/>
</p>
<a name="more"></a>
</div>
<br/>
