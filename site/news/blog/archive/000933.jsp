...
<link href="000932.jsp" rel="prev" title=" Please Upload Your Etoys Projects"/>
<link href="000934.jsp" rel="next" title=" Etoys 4 release candidate 2"/>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/archive/000933.jsp">
<dc:title>squeakland showcase is done, for now</dc:title>
<dc:description>I&apos;ve finished my work on the new Squeakland showcase. It should be considered beta (feature complete), with only bug fixes till next month. You can watch the new Showcase Preview video. Please take the time to watch this before making suggestions on how to improve it. To create an account so you can upload projects to the showcase, click here. We *really* need you to upload good projects. We&apos;ll be doing a great deal of publicity for Etoys 4 and the showcase in late October. Till then, please upload projects, ask others to upload projects, and comment on projects. Consider...</dc:description>
<dc:creator>timothy</dc:creator>
<dc:date>2009-09-29T04:29:07-08:00</dc:date>
...
<a href="000932.jsp">«  Please Upload Your Etoys Projects</a> |
   ...
   | <a href="000934.jsp"> Etoys 4 release candidate 2 »</a>
</div>
<br/>
<br/>
<div class="entryDate">September 29, 2009</div>
<a name="000933"></a>
<div class="entryTitle">
  squeakland showcase is done, for now<br/>
</div>
<div class="entryText">
<p>I've finished my work on the new Squeakland showcase. It should be considered beta (feature complete), with only bug fixes till next month.</p>
<p>You can watch the new <a href="../../../resources/audioVisual/movie.jsp">Showcase Preview video.</a></p>
<p>Please take the time to watch this before making suggestions on how to improve it.</p>
<p>To create an account so you can upload projects to the showcase, click <a href="../../../action/signup.html">here</a>.</p>
<p>We *really* need you to upload good projects. We'll be doing a great deal of publicity for Etoys 4 and the showcase in late October.</p>
<p>Till then, please upload projects, ask others to upload projects, and comment on projects.</p>
<p>Consider this the "housewarming" period, where friends and family spruce up the place before the big party.</p>
<p>Please help!</p>
<p>Suggestions for showcase improvements can be added here:</p>
<p><a href="../../../index.html">http://tracker.squeakland.org</a></p>
<p>1. click "showcase" to see other open issues, so you don't duplicate them</p>
<p>2. make an account</p>
<p>3. click "Create new Issue"</p>
<p>4. describe the issue, using "showcase" as the component</p>
<p>Such suggestions will be reviewed by Squeakland for possible inclusion in November.</p>
<p>Thank you for all of your suggestions and help. Now go tell some friends about it :)</p>
<a name="more"></a>
</div>
<br/>
<div class="entryLinks">
