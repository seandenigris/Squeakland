...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: Etoys</title>
<!--
...
<title> squeakland : news : blog : category </title>
...
<br/>
<!-- content start -->
<a class="entryTitle" href="000939.jsp">100 tickets for the next Etoys</a>   <span class="entryLinks">24-Nov-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         We've gone through the list of 190+ tickets in JIRA and reduced that to an even 100 for the next version of Etoys, expected June 2010. http://tracker.squeakland.org If you'd like to champion particular issues, try voting in JIRA, which is now much more obvious because of the Popular Issues tab in JIRA. Simply click on the issue you want, the look to the left and click "Vote for it". This will raise the issue in our awareness :) And if you have any new ideas, simple create the issue. You need a JIRA account to vote or create issues. (It's...
      </div>
<br/>
<br/>
<br/>
<a class="entryTitle" href="000937.jsp"> Etoys 4 has been released!</a>   <span class="entryLinks">24-Oct-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         Squeakland is proud to announce the release of Etoys 4, which you can now download from our website. Special thanks to the Squeakland software team, particularly Bert Freudenberg, Yoshiki Ohshima, and Scott Wallace for their tremendous efforts in the last month. Your hard work really shows! http://squeakland.org/download/'&gt; http://squeakland.org/download/ In our Fall newsletter, you'll find some thoughts by Scott Wallace, along with the Etoys 4 release notes which detail the changes you'll find. Of special interest is the new Squeakland Showcase. Everyone can now share their projects directly from Etoys to our website, where the Etoys community can then benefit from...
      </div>
<br/>
<br/>
<br/>
...
<br/>
<br/>
<a class="entryTitle" href="000841.jsp">etoys poem by Kathleen Harness</a>   <span class="entryLinks">05-Feb-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         Are you a painter, a writer, a poet, a wit Are you a thinker, a reader, a writer, a clown Are you a seeker, a dreamer, a searcher, a seer? Open a world; Come in!...
      </div>
<br/>
<br/>
<br/>
