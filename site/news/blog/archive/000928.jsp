...
<link href="000939.jsp" rel="prev" title="100 tickets for the next Etoys"/>
<link href="000940.jsp" rel="next" title="squeak if you like etoys button"/>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/archive/000928.jsp">
<dc:title>First Squeakland Book Sprint</dc:title>
<dc:description> Squeakland will have it&apos;s first Book Sprint to create a Reference Manual for Etoys! Please join us online during the week of December, 7 to December12, 2009. The book will serve as - the manual you can look up every part of Etoys, - the documentation of what we commit to support in Etoys and - the starting point for other, more elaborate materials. For writing we intend to use FLOSS Manuals. The manual will be available online (html and pdf format), and as a real book per print-on-demand. It will be licensed under MIT, so that we can...</dc:description>
<dc:creator>timothy</dc:creator>
<dc:date>2009-11-26T04:19:01-08:00</dc:date>
...
<a href="000939.jsp">« 100 tickets for the next Etoys</a> |
   ...
   | <a href="000940.jsp">squeak if you like etoys button »</a>
</div>
<br/>
<br/>
<div class="entryDate">November 26, 2009</div>
<a name="000928"></a>
<div class="entryTitle">
  First Squeakland Book Sprint<br/>
</div>
<div class="entryText">
<p> Squeakland will have it's first Book Sprint to create a Reference Manual for Etoys! Please join us online during the week of December, 7 to December12, 2009. The book will serve as</p>
<p>- the manual you can look up every part of Etoys,<br/>
- the documentation of what we commit to support in Etoys and<br/>
- the starting point for other, more elaborate materials.<br/>
For writing we intend to use FLOSS Manuals.</p>
<p>The manual will be available online (html and pdf format), and as a real book per print-on-demand. It will be licensed under MIT, so that we can also ship it within Etoys. We will work on it for a whole week from December, 7th until December, 12th. At this point, we are not planning a central in-person meeting, but the whole event will take place virtually on the internet. We will chat on an irc channel, and we will haveaudio chats every day to provide the opportunity for a talk. Of course, if you can organize a local meeting somewhere, that would be great!</p>
<p>You can find more information on the <a href="../../../display/sq/Book+Sprint.html">wiki page</a>.</p>
<p>We will examine if we really need all the objects we currently have in the Etoys image. This documentation will be a list of all things our users can expect to be working fine in Etoys, we should leave out objects we will not support in terms of maintaining. That doesn't mean we will remove it from Etoys, but we will not include it in the documentation. So we really need developers to participate at least in the first discussion on December, 7 at 2 pm EST (which happens to be the time of the regular software meeting :) .</p>
<p>To join the sprint, please put your name on the wiki or send me a message.</p>
<a name="more"></a>
</div>
<br/>
<div class="entryLinks">
