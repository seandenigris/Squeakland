...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: book sprint</title>
<!--
...
<br/>
<!-- content start -->
<a class="entryTitle" href="000941.jsp">first book sprint is over</a>   <span class="entryLinks">18-Dec-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         Our first book sprint was a great kick-off for our effort to write the Etoys Reference Manual. Here you can read how it went and how we plan to go on: We started the sprint on Monday, December 7th, with a first discussion about the structure, target audience and FLOSS Manuals. We started writing the first parts then and met again for an audio call on Tuesday. We had a longer discussion and agreed on the structure now available on the wiki page: http://wiki.squeakland.org/display/sq/Book+Sprint On the other days I had audio chats with Cherry, Randy and Stephen Thomas, mostly about...
      </div>
<br/>
<br/>
<br/>
<a class="entryTitle" href="000931.jsp">please join us in the Etoys chat channel</a>   <span class="entryLinks">08-Dec-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         We're in day two of our Etoys book sprint! Please spend time with us in the Etoys chat channel to help motivate everyone. Usually book sprints are done in person, so we're using our chat channel as a way to spend time together. It's a great way to meet other Etoys enthusiasts and help the writers at the same time. There are two ways to visit our chat channel . . . 1) visit http://chat.squeakland.org and put your nickname in place of "squeaker###". Simply type messages at the bottom of the screen and click Enter. 2) download and install an...
      </div>
<br/>
<br/>
<br/>
