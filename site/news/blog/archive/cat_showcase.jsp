...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: showcase</title>
<!--
...
<br/>
<!-- content start -->
<a class="entryTitle" href="000938.jsp">showcase fixes</a>   <span class="entryLinks">09-Nov-09 (teefal)</span><br/>
<br/>
<div class="entryText">
          We had a real backlog of projects waiting to go live on the site. This weekend I tweaked several things and fixed a few bugs, and as a result, a slew of new ballots went out. Now every public project has at least one vote, which means they're all visible. We're up to 102 projects! Quite a selection. Lots of great stuff. http://squeakland.org/showcase/ On a more technical note, I changed the "re-ballot" priority to make things more fair. As ballots expire, projects are picked to get new ballots. Before tonight I favored projects that were the oldest. I've switched...
      </div>
<br/>
<br/>
<br/>
