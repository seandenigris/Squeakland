...
<a href="000817.jsp">« music of the spheres</a> |
   ...
   | <a href="000827.jsp">Building the Community »</a>
</div>
<br/>
<br/>
<div class="entryDate">January 20, 2009</div>
<a name="000826"></a>
<div class="entryTitle">
  Spotlight: OLPC Learning Club DC<br/>
</div>
<div class="entryText">
<p>(by Mike Lee, from <a href="../../newsletter/web.jsp">newsletter</a> </p>
<p>The <a href="../../../index.html">OLPC Learning Club</a> of Washington DC, a diverse grassroots group of XO laptop users with a passion for education, held its first content jam session as part of our January meeting at the Arlington Career Center (ACC) in Virginia.</p>
<p>Though OLPC-style jams are typically intensive work sessions focused on producing content for the laptop, this time we chose to ease into the world of Squeak and Etoys by conducting a qualitative review of a series of Etoys-based activities created several years ago for the NASA Connect series. Our project took on the name "Etoys in Space."</p>
<p>With valuable prior input from Viewpoints Research, Waveplace Foundation, Nortel Networks, Arlington County Public School System, OLPC, and Randy Caton (formerly of NASA), the jam team was able to inventory content, review guidelines, and brainstorm new ideas. The jam team logged suggestions for improving the usability and classroom applicability of the activities. We reviewed five of the twelve activities. I'll be collating the notes to inform Randy as he prepares to do an update of the activities this spring.</p>
<p>The Learning Club believes this successful Jam will increase interest in having more sessions throughout the year.<br/>
</p>
<a name="more"></a>
</div>
<br/>
