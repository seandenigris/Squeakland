...
<link href="000928.jsp" rel="prev" title="First Squeakland Book Sprint"/>
<link href="000930.jsp" rel="next" title="book sprint has started!"/>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/archive/000940.jsp">
<dc:title>squeak if you like etoys button</dc:title>
<dc:description><![CDATA[Try adding this to your favorite webpage: &lt;iframe style="border: none" src="http://squeakland.org/squeakers/squeakerButton.jsp" width="270" height="143"&gt;&lt;/iframe&gt; It'll look and work like this: We'll be promoting this, along with it's static cousin at: http://squeakland.org/linking/ Want to make sure the flash button (the first one) works on many browsers & websites before going public with it. And yes, I know Flash doesn't work in various places. I'm asking to test this button in the places where Flash works (aka, anywhere you can see a YouTube video)....]]></dc:description>
<dc:creator>timothy</dc:creator>
<dc:date>2009-12-06T04:37:49-08:00</dc:date>
...
<a href="000928.jsp">« First Squeakland Book Sprint</a> |
   <a href="../index.html">Main</a>
   | <a href="000930.jsp">book sprint has started! »</a>
</div>
<br/>
<br/>
<div class="entryDate">December 06, 2009</div>
<a name="000940"></a>
<div class="entryTitle">
  squeak if you like etoys button<br/>
</div>
<div class="entryText">
<p>Try adding this to your favorite webpage:</p>
<p>&lt;iframe style="border: none" src="http://squeakland.org/squeakers/squeakerButton.jsp" width="270" height="143"&gt;&lt;/iframe&gt;</p>
<p>It'll look and work like this:</p>
<pre>
<iframe height="143" src="../../../squeakers/squeakerButton.jsp" style="border: none" width="270"></iframe>
</pre>
<p>We'll be promoting this, along with it's static cousin at:</p>
<p><a href="../../../linking/index.html">http://squeakland.org/linking/</a></p>
<p>Want to make sure the flash button (the first one) works on many browsers &amp; websites before going public with it.</p>
<p>And yes, I know Flash doesn't work in various places.  I'm asking to test this button in the places where Flash works (aka, anywhere you can see a YouTube video).<br/>
</p>
<a name="more"></a>
</div>
<br/>
