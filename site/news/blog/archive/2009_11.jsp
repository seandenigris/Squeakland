...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: November 2009</title>
<!--
...
<br/>
<br/>
<a class="entryTitle" href="000928.jsp">First Squeakland Book Sprint</a>   <span class="entryLinks">26-Nov-09 (teefal)</span><br/>
<br/>
<div class="entryText">
          Squeakland will have it's first Book Sprint to create a Reference Manual for Etoys! Please join us online during the week of December, 7 to December12, 2009. The book will serve as - the manual you can look up every part of Etoys, - the documentation of what we commit to support in Etoys and - the starting point for other, more elaborate materials. For writing we intend to use FLOSS Manuals. The manual will be available online (html and pdf format), and as a real book per print-on-demand. It will be licensed under MIT, so that we can...
      </div>
<br/>
<br/>
<br/>
