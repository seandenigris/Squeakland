...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title>Squeak Etoys Blog: September 2009</title>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/">
<dc:title>Squeak Etoys Blog</dc:title>
<dc:description>The latest news on Squeak Etoys</dc:description>
...
<title> squeakland : news : blog : month </title>
...
<br/>
<!-- content start -->
<a class="entryTitle" href="000929.jsp"> Etoys 4 release candidate and beta showcase</a>   <span class="entryLinks">19-Sep-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         After nine months of work by our software team, and several weeks of sprinting by Bert Freudenberg, Yoshiki Ohshima, Scott Wallace, and myself, we're very happy to announce the Squeak Etoys 4 release candidate! What's a release candidate, you ask? Well, it's hopefully the final version, but we want more testing first. It's better than a beta, but not quite ready for real use. We'll be releasing the Etoys 4 final on October 21st. Please help us test the new Etoys! We want to make sure that it's rock solid before getting used in schools and homes throughout the world....
      </div>
<br/>
<br/>
<br/>
<a class="entryTitle" href="000932.jsp"> Please Upload Your Etoys Projects</a>   <span class="entryLinks">20-Sep-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         With the launch of the beta Squeakland Showcase, we'd love for any and all to upload their favorite Etoys projects! Think of it as a Squeakland housewarming party, which for those that don't know the term, it's when friends come to your new house with gifts to make the house nicer for everyone. There's two ways you can upload projects: 1) If you're using the Etoys 4 release candidate, you can upload directly from Etoys. 2) If you're already got some PR files, the go to the showcase upload page: http://squeakland.org/showcase/upload'&gt; http://squeakland.org/showcase/upload Either way, you'll need to create a free...
      </div>
<br/>
<br/>
<br/>
<a class="entryTitle" href="000933.jsp">squeakland showcase is done, for now</a>   <span class="entryLinks">29-Sep-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         I've finished my work on the new Squeakland showcase. It should be considered beta (feature complete), with only bug fixes till next month. You can watch the new Showcase Preview video. Please take the time to watch this before making suggestions on how to improve it. To create an account so you can upload projects to the showcase, click here. We *really* need you to upload good projects. We'll be doing a great deal of publicity for Etoys 4 and the showcase in late October. Till then, please upload projects, ask others to upload projects, and comment on projects. Consider...
      </div>
<br/>
<br/>
<br/>
<a class="entryTitle" href="000934.jsp"> Etoys 4 release candidate 2</a>   <span class="entryLinks">30-Sep-09 (teefal)</span><br/>
<br/>
<div class="entryText">
         We've just posted the second Etoys 4 release candidate: http://squeakland.org/download/ (scroll to bottom of page) This one has more translations and some bug fixes. We're one step closer to our final release on October 21st. Please help us by testing RC2 with your existing projects, and some new ones. And while you're there, upload a few to the showcase! Feel free to add tickets to our tracker. Here's a list of RC2 changes. Here's a list of current known issues....
      </div>
<br/>
<br/>
<br/>
