...
<link href="000813.jsp" rel="prev" title="Waveplace Awards"/>
<link href="000817.jsp" rel="next" title="music of the spheres"/>
<!--
<rdf:RDF xmlns="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/"
         xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<Work rdf:about="http://squeakland.org/news/blog/archive/000815.jsp">
<dc:title>Etoys in Uruguay</dc:title>
<dc:description>Here is a link out of Uruguay showing how to use Etoys to create &quot;books&quot;: http://ceibalflorida.blogspot.com/search/label/etoys They are still using XO SW release 656 in Uruguay and I&apos;m not sure which version of Etoys they have (maybe you can tell from the screen shots?). Its great that they have learned how to create books, include images from the XO camera and post that to the Web. That&apos;s not trivial with XO 656! There are also some posts on using eToys to teach geometry. Lastly, I saw a thread on using EToys to create concept maps on our Spanish language list....</dc:description>
<dc:creator>timothy</dc:creator>
<dc:date>2008-11-26T13:55:17-08:00</dc:date>
...
<a href="000813.jsp">« Waveplace Awards</a> |
   <a href="../index.html">Main</a>
   | <a href="000817.jsp">music of the spheres »</a>
</div>
<br/>
<br/>
<div class="entryDate">November 26, 2008</div>
<a name="000815"></a>
<div class="entryTitle">
  Etoys in Uruguay<br/>
</div>
<div class="entryText">
<p>Here is a link out of Uruguay showing how to use Etoys to create "books":</p>
<p><a href="../../../search/label/etoys.html">http://ceibalflorida.blogspot.com/search/label/etoys</a></p>
<p>They are still using XO SW release 656 in Uruguay and I'm not sure which version of Etoys they have (maybe you can tell from the screen shots?).</p>
<p>Its great that they have learned how to create books, include images from the XO camera and post that to the Web. That's not trivial with XO 656!</p>
<p>There are also some posts on using eToys to teach geometry.</p>
<p>Lastly, I saw a thread on using EToys to create concept maps on our Spanish language list.</p>
<a name="more"></a>
</div>
<br/>
<div class="entryLinks">
