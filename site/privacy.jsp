...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title> squeakland : privacy </title>
...
<td><img alt="" border="0" height="29" id="navTop" name="navTop" src="images/mainNav.png" usemap="#mainNavMap" width="368"/></td>
...
<div class="articleBody" id="body4005">
               ...
               Your privacy and safety online are very important to us. To protect your privacy, we limit what we collect and what we publish on the website, and we do not share your data with anyone.<br/>
</div>
</td>
</table></td></tr>
</table>
...
<div class="articleBody" id="body4006">
               ...
               You do not have to tell us anything about yourselves to download the Etoys software.<br/>
</div>
</td>
...
<div class="articleBody" id="body4007">
               ...
               You can try out projects on our website without providing any information. <br/>
<br/>
When you subscribe to our mailing list, we ask for some information. The only required information is your email address. We do not make any of this information public.<br/>
<br/>
When you sign up for an account, we require a username, password, and email address.  The only information that appears on the website is your username.<br/>
<br/>
Children under 13 are not permitted to create their own accounts.  They must ask a parent or guardian to create their account, using the parent or guardian's email address. Children should refrain from putting last names or other identifying material in usernames or within any Etoys projects that they share.<br/>
<br/>
We put a "cookie" on your computer to allow you to use the website. A cookie is a small data file that indicates you are the same person during a session.<br/>
<br/>
We do not share, sell, or rent your information to anyone. We do not have any third-party content, advertising, or cookies.<br/>
</div>
</td>
