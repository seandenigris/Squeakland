...
<!--[if lte IE 6]>
   ...
   <![endif]-->
<title> squeakland : tutorials : screencasts : movie </title>
...
<area alt="Tutorials" coords=" 75, 7, 140, 27" href="../index.html" shape="rect" title="Tutorials"/>
...
<td><img alt="" border="0" height="29" id="navTop" name="navTop" src="../../images/mainNav-tutorials.png" usemap="#mainNavMap" width="368"/></td>
...
<div class="subNav">
<ul>
<li class="vertRule"><a href="../../resources/community/index.html" style="color: #009900;">screencasts</a></li>
<li class="vertRule"><a href="../../resources/articles/index.html">quick guides</a></li>
<li class="vertRule"><a href="../../resources/books/index.html">demos</a></li>
<li><a href="../../resources/audioVisual/index.html">audio/visual</a></li>
</ul>
</div>
</td>
...
<br/>
<!-- content start -->
<script src="../../sm/includes/swfobject.js" type="text/javascript"></script>
<script src="../../sm/includes/AC_OETags.js" type="text/javascript"></script>
<div align="center">
...
<area alt="next" coords="66,3,102,22" href="movie.jsp" shape="rect" title="next"/>
...
<td width="10%"> </td>
<td width="80%">
<span class="body">Lesson 10 - naming sketches, starting scripts</span>
</td>
<td width="10%"> </td>
</tr>
<tr><td> </td></tr>
...
<script language="JavaScript" type="text/javascript">
                  <!--
                     ...
                     {
                        var so = new SWFObject('/sm/includes/flvplayer.swf','player','600','470','7');
                        so.addParam("allowfullscreen","true");
                        so.addVariable("file","http://www.squeakland.org/content/movies/lesson10.flv" );
...
<br/>
<br/>
<a href="../../go/getflashplayer.html"><img border="0" src="../../sm/images/get_flash_player.gif"/></a>
</td>
</tr>
</table>
...
<a href="../../action/commentAdd.html">add comment</a>      
